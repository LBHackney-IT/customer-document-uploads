...
module.exports = options => {
  ...
  return async (dropboxId, fields) => {
    ...
    if(fields.customerName && fields.customerName !== '') data.customerName = fields.customerName;
    if(fields.description && fields.description !== '') data.description = fields.description;
    ...
    if(fields.newUploadFile){
      ...
      await saveFile(dropboxId, fileId, fields.newUploadFile.filename, Buffer.from(fields.newUploadFile.content, 'binary'));
    }
